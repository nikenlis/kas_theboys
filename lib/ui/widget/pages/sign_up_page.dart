...
import 'package:the_boys/shared/share_method.dart';
          ...
          Text(
            ...
            child: Column(
              children: [
                ...
                //NOTE: EMAIL INPUT
                CustomFormField(title: 'Email Address', controller: emailController,),
                const SizedBox(
                  height: 16,
                ),
                //NOTE: NUMBER INPUT
                CustomFormField(title: 'Phone Number', controller: phoneController,),
                const SizedBox(
                  height: 16,
                ),
                //NOTE: PASSWORD INPUT
                ...
                CustomGradienFilledButton(title: 'Continue', onPressed: () {
                  if (validate()) {
